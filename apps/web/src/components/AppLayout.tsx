import { BarChart3, FilePlus2, Files, LogOut, Menu, Sheet, Users, X, User, Search, Calculator } from "lucide-react";
...
const links = [
  ...
  { to: "/calculator", label: "Tính phí nộp về", icon: Calculator },
