...
type AuthContextValue = { user: User | null; loading: boolean; login: (username: string, password: string) => Promise<void>; logout: () => void; updateUser: (user: User) => void };
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  function updateUser(updated: User) { setUser(updated); }
